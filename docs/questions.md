...
Έτρεξα το transfer learning που είχαμε συζητήσει την τελευταία φορά και, επειδή έχω κάνει κάποιες διευκολύνσεις για να λειτουργήσει, θα ήθελα – όποτε σας βολεύει – να το συζητήσουμε για να δω αν η μεθοδολογία είναι αποδεκτή.
