...
Έτρεξα το transfer learning που είχαμε συζητήσει την τελευταία φορά και, επειδή έχω κάνει αρκετες διευκολυνσεις για να δουλέψει, θα ήθελα – όποτε σας βολεύει – να το συζητησουμε, για να ξερω αμα ειναι αποδεκτο.
