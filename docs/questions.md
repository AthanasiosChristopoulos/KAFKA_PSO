...
Ερωτησεις για Διπλωματικη:
	...
	- Experimentation: =============================================================
		...
		- Μπορω να αρχισω να γραφω την διπλωματικη ?
	...
	Έκανα αυτά που συζητήσαμε την τελευταία φορά. Αρχικά τα διαγράμματα συνεχίζουν να πηγαίνουν καλά.

	Το NSFW Dataset αποδείχτηκε ακόμα πιο δύσκολο από το CIFAR, όμως για το CIFAR δοκίμασα την προσέγγιση (φαίνεται να ονομάζεται "Continual Learning"), όπου το pretrained μοντέλο και το PSO training βλέπουν διαφορετικά δεδομένα. Αυτό είχε μεγαλύτερη επιτυχία, αλλά και πάλι είναι από CIFAR-10 στο CIFAR-5, οπότε δεν ξέρω αν είναι αρκετά καλό.

	Για αυτόν τον λόγο, θα ήθελα να ρωτήσω αν έχει νόημα να βάλω κάποιο dataset, πχ το KMNIST ή το FASHION-MNIST, που είναι λίγο πιο δύσκολα από το MNIST, αντί για το CIFAR ή αν είναι προτιμότερη η προσέγγιση που περιγράφω παραπάνω.
