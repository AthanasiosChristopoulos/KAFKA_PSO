...
Εκανα αυτα που συζητησαμε την τελευταια φορα. Αν και το NSFW Dataset αποδειχτηκε ακομα πιο δυσκολο απο το Cifar, δοκιμασα επισης την προσσεγιση (φαινεται να ονομαζεται "Continiual Learning"), οπου το pretrained μοντελλο και το PSO training και το βλεπουν διαφορετικα δεδομενα (στο Cifar). Αυτο ειχε μεγαλυτερη επιτυχια, αλλα δεν ξερω αμα ο τροπος που το υλοποιησα ειναι αρκετα καλος.

 και θα ηθελα οποτε σας βολευει να τα συζητησουμε.
