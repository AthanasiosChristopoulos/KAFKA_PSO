...
Ερωτησεις για Διπλωματικη:
	...
	- Experimentation: =============================================================
		...
		- Για τα διαγραμματα δεν μετραω πλεον system time, αλλα time απο το πρωτο record (αγνοω overhead) => θεωρω training begins. Το overhead ειναι πολυ μεγαλο (7 seconds)  και μου χαλαει την ποιοτητα των γραφηματων, ειδικα στα μικρα datasets
