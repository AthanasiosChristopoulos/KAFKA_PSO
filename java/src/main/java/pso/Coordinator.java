...
public class Coordinator implements Runnable {
    ...
    public void run() {
        ...
        System.out.println("KAFKA_HOST: " + cfg.KAFKA_HOST);
            ...
            try {
                ...
                if(collector != null) {
                    collector.reportCoordinatorDone(new CoordinatorMetrics(seconds, 
                        ...
                        control.accuracyValues, this.dimensionality, control.avgWeightsMessageDelayMsSum));
                }
                ...
                System.out.println("Avg Communication Delay Ms: " + control.avgWeightsMessageDelayMsSum);
