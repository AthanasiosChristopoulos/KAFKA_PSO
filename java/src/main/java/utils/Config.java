...
public class Config {
    ...
    public boolean FEDERATED_SETTING;
    ...
    public void setAllEnviromentVariables() {
        ...
        if("iris".equals(DATASET)) {
            ...
            NUM_FEATURES = Integer.parseInt(getenv(dotenv, "NUM_FEATURES_FASHION_MNIST5_HALF", "784"));
            NUM_CLASSES = Integer.parseInt(getenv(dotenv, "NUM_CLASSES_FASHION_MNIST5_HALF", "5"));
        ...
        RUN_ID = LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss")); 
        ...
        FEDERATED_SETTING = Boolean.parseBoolean(getenv(dotenv, "FEDERATED_SETTING", "false"));
    ...
    public static void printExecutionInfo() {
        try {
            ...
            for (NetworkInterface netint : Collections.list(nets)) {
                ...
                System.out.println("  Interface: " + netint.getName() + " (" + netint.getDisplayName() + ")");
